      ...
      <div className='flex'>
        ...
        <div className='project-company'>
          <div className='project-social'>
            ...
            <p className='company-info'>O Tampinha Legal é o maior programa socioambiental de caráter educativo em 
              economia circular de iniciativa da indústria de transformação do plástico da América Latina.</p>
          </div>
        </div>
      </div>
